...
import 'package:flutter_songbei/pages/message_center/chats_page.dart';
import 'package:flutter_songbei/pages/message_center/message_details_page.dart';
...
class _PageState extends State<MessageTab>
...
//    );
  ...
  void _onItem(MessageModel message) {
    ...
    if (message.type == 1 || message.type == 2 || message.type == 5) {
      ...
      // Navigator.push(
      //     context, MaterialPageRoute(builder: (context) => PoemPage(pid)));
